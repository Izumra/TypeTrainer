<script>
  ...
  function checkKey(e){
    if(e.key!='Shift'&&checkText.length!=0){
      ...
      if(e.key==text[enterSymbols])curentSymbol++
      enterSymbols++
      enterText+=e.key
      checkText=checkText.slice(1,checkText.length)
...
<div class="wrap">
  <div class="stats trueText">
    Правильных символов / всего: {curentSymbol+"|"+enterSymbols}
  </div>
  <header>
    <div class="logo">
      Type trainer
